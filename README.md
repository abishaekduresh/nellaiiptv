...
- **Version**: 1.8.19+35 (Main) / 1.2.3+4 (Single Channel)
- **Key Features**: TV Playback Optimization, Branding Update, Hardware-Aware Profiling.

## Recent Updates (v1.8.19+35 App / v1.47.1 Website / v1.36.1 Backend)
