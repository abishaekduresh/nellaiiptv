...
CREATE TABLE IF NOT EXISTS `stream_servers` (
  ...
  `uuid` char(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'UUID v7 identifier',
  `server_name` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `server_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Short internal identifier',
  `description` text COLLATE utf8mb4_unicode_ci,
  `host_ipv4` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `host_ipv6` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `host_domain` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mist_api_protocol` enum('http','https') COLLATE utf8mb4_unicode_ci DEFAULT 'http',
  `mist_api_host` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mist_api_port` int NOT NULL DEFAULT '4242',
  `mist_server_username` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mist_server_password` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Encrypted password/hash',
  `mist_challenge` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Last challenge received from MistServer',
  `mist_final_hash` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Last computed MD5 auth hash (challenge-response)',
  `rtmp_publish_base_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hls_base_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `https_hls_base_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cmaf_base_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `webrtc_base_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `srt_base_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `server_type` enum('vps','dedicated','cloud','baremetal') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'vps',
  `provider_name` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'OVH, Hetzner, Contabo etc',
  `datacenter_region` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Singapore, France, Chennai',
  ...
  `kernel_version` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cpu_model` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cpu_cores` int DEFAULT NULL,
  `cpu_threads` int DEFAULT NULL,
  `memory_total_mb` bigint DEFAULT NULL,
  `disk_total_gb` bigint DEFAULT NULL,
  `bandwidth_limit_tb` decimal(10,2) DEFAULT NULL COMMENT 'Monthly bandwidth limit',
  `network_speed_mbps` int DEFAULT NULL,
  `gpu_enabled` tinyint(1) DEFAULT '0',
  `max_streams` int DEFAULT NULL,
  `max_viewers` int DEFAULT NULL,
  `current_streams` int DEFAULT '0',
  `current_viewers` int DEFAULT '0',
  `health_status` enum('online','offline','warning','maintenance') COLLATE utf8mb4_unicode_ci DEFAULT 'offline',
  `purchased_at` timestamp NULL DEFAULT NULL,
  `expiry_at` timestamp NULL DEFAULT NULL,
  `last_seen_at` timestamp NULL DEFAULT NULL,
  `last_stats_sync_at` timestamp NULL DEFAULT NULL,
  `supports_hls` tinyint(1) DEFAULT '1',
  `supports_rtmp` tinyint(1) DEFAULT '1',
  `supports_cmaf` tinyint(1) DEFAULT '1',
  `supports_webrtc` tinyint(1) DEFAULT '0',
  `supports_srt` tinyint(1) DEFAULT '0',
  `supports_transcoding` tinyint(1) DEFAULT '0',
  `api_whitelist_enabled` tinyint(1) DEFAULT '0',
  `ssl_enabled` tinyint(1) DEFAULT '0',
  `status` enum('active','inactive','expired','suspended','deleted') COLLATE utf8mb4_unicode_ci DEFAULT 'active',
