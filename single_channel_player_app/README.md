...
**Version**: `1.3.7+13` — Play Store fix (ENABLE_DEBUG_BLOCK disabled) + build environment fix (cmdline-tools stub)
...
- **Package Name**: `com.nellaiiptv.vezhamugamtv` (Play Store)
- **Permissions**:
